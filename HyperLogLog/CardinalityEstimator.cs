...
//{
//    [Serializable]
//    public class CardinalityEstimator : IHyperLogLog<string>, IHyperLogLog<int>, IHyperLogLog<uint>,
...
//            this.hashFunction = new FastHash();
...
//        {
//            AddElementHash(this.hashFunction.GetHashCode(element));
//            this.CountAdditions++;
//        }
